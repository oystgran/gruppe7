<template>
  <div class="svg-container">
    <svg version="1.0" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" viewBox="0 124.488 1580.0249687890137 741" style="max-height: 500px" width="1580.0249687890137" height="741">
      <g class="spots">
        <g class="spot1">
          <rect @mouseover="showTooltip(1)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 1)" :class="{ occupied: guests[1] }" fill="#394856" stroke="#394856" x="1482.97202" y="654.50685" width="40" height="60" id="svg_5" rx="5" transform="rotate(-20 1502.97 684.506)"/>
        ...
        <g class="spot2">
          <rect @mouseover="showTooltip(2, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 2)" :class="{ occupied: guests[2] }" fill="#394856" stroke="#394856" x="1433.91939" y="670.59707" width="40" height="60" id="svg_3" rx="5" transform="rotate(-15 1453.92 700.596)"/>
        ...
        <g class="spot3">
          <rect @mouseover="showTooltip(3, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 3)" :class="{ occupied: guests[3] }" fill="#394856" stroke="#394856" x="1380.49082" y="682.50184" width="40" height="60" id="svg_4" rx="5" transform="rotate(-15 1400.49 712.501)"/>
        ...
        <g class="spot4">
          <rect @mouseover="showTooltip(4, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 4)" :class="{ occupied: guests[4] }" fill="#394856" stroke="#394856" x="1330.16931" y="703.75206" width="40" height="60" id="svg_12" rx="5" transform="rotate(-24 1350.17 733.751)"/>
        ...
        <g class="spot5">
          <rect @mouseover="showTooltip(5, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 5)" :class="{ occupied: guests[5] }" fill="#394856" stroke="#394856" x="1282.47853" y="729.96113" width="40" height="60" id="svg_13" rx="5" transform="rotate(-28 1302.48 759.961)"/>
        ...
        <g class="spot6">
          <rect @mouseover="showTooltip(6, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 6)" :class="{ occupied: guests[6] }" fill="#394856" stroke="#394856" x="1233.12776" y="753.84124" width="40" height="60" id="svg_9" rx="5" transform="rotate(-20 1253.13 783.841)"/>
        ...
        <g class="spot7">
          <rect @mouseover="showTooltip(7, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 7)" :class="{ occupied: guests[7] }" fill="#394856" stroke="#394856" x="1180.84205" y="767.68049" width="40" height="60" id="svg_7" rx="5" transform="rotate(-12 1200.84 797.68)"/>
        ...
        <g class="spot8">
          <rect @mouseover="showTooltip(8, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 8)" :class="{ occupied: guests[8] }" fill="#394856" stroke="#394856" x="1126.58604" y="775.49002" width="40" height="60" id="svg_14" rx="5" transform="rotate(-7 1146.59 805.489)"/>
        ...
        <g class="spot9">
          <rect @mouseover="showTooltip(9, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 9)" :class="{ occupied: guests[9] }" fill="#394856" stroke="#394856" x="1071.63368" y="779.54947" width="40" height="60" id="svg_6" rx="5" transform="rotate(-4 1091.63 809.549)"/>
        ...
        <g class="spot10">
          <rect @mouseover="showTooltip(10, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 10)" :class="{ occupied: guests[10] }" fill="#394856" stroke="#394856" x="1014.01463" y="778.12089" width="40" height="60" id="svg_10" rx="5"/>
        ...
        <g class="spot11">
          <rect @mouseover="showTooltip(11, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 11)" :class="{ occupied: guests[11] }" fill="#394856" stroke="#394856" x="963.25272" y="768.4066" width="40" height="60" id="svg_11" rx="5" transform="rotate(7 983.253 798.406)"/>
        ...
        <g class="spot12">
          <rect @mouseover="showTooltip(12, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 12)" :class="{ occupied: guests[12] }" fill="#394856" stroke="#394856" x="912.58604" y="753.359" width="40" height="60" id="svg_19" rx="5" transform="rotate(14 932.586 783.358)"/>
        ...
        <g class="spot13">
          <rect @mouseover="showTooltip(13, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 13)" :class="{ occupied: guests[13] }" fill="#394856" stroke="#394856" x="863.15747" y="736.02566" width="40" height="60" id="svg_21" rx="5" transform="rotate(20 883.157 766.025)"/>
        ...
        <g class="spot14">
          <rect @mouseover="showTooltip(14, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 14)" :class="{ occupied: guests[14] }" fill="#394856" stroke="#394856" x="812.30037" y="715.93041" width="40" height="60" id="svg_8" rx="5" transform="rotate(20 832.3 745.93)"/>
        ...
        <g class="spot15">
          <rect @mouseover="showTooltip(15, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 15)" :class="{ occupied: guests[15] }" fill="#394856" stroke="#394856" x="758.49084" y="691.54946" width="40" height="60" id="svg_23" rx="5" transform="rotate(24 778.491 721.549)"/>
        ...
        <g class="spot16">
          <rect @mouseover="showTooltip(16, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 16)" :class="{ occupied: guests[16] }" fill="#394856" stroke="#394856" x="709.06223" y="666.21612" width="40" height="60" id="svg_15" rx="5" transform="rotate(27 729.062 696.215)"/>
        ...
        <g class="spot17">
          <rect @mouseover="showTooltip(17, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 17)" :class="{ occupied: guests[17] }" fill="#394856" stroke="#394856" x="661.06222" y="639.35898" width="40" height="60" id="svg_16" rx="5" transform="rotate(28 681.062 669.358)"/>
        ...
        <g class="spot18">
          <rect @mouseover="showTooltip(18, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 18)" :class="{ occupied: guests[18] }" fill="#394856" stroke="#394856" x="607.34795" y="613.73993" width="40" height="60" id="svg_20" rx="5" transform="rotate(25 627.348 643.739)"/>
        ...
        <g class="spot19">
          <rect @mouseover="showTooltip(19, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 19)" :class="{ occupied: guests[19] }" fill="#394856" stroke="#394856" x="552.30034" y="595.54947" width="40" height="60" id="svg_18" rx="5" transform="rotate(15 572.3 625.549)"/>
        ...
        <g class="spot20">
          <rect @mouseover="showTooltip(20, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 20)" :class="{ occupied: guests[20] }" fill="#394856" stroke="#394856" x="1455.82916" y="575.93542" width="40" height="60" id="svg_27" rx="5" transform="rotate(-20 1475.83 605.935)"/>
        ...
        <g class="spot21">
          <rect @mouseover="showTooltip(21, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 21)" :class="{ occupied: guests[21] }" fill="#394856" stroke="#394856" x="1406.77653" y="589.1685" width="40" height="60" id="svg_28" rx="5" transform="rotate(-15 1426.78 619.168)"/>
        ...
        <g class="spot22">
          <rect @mouseover="showTooltip(22, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 22)" :class="{ occupied: guests[22] }" fill="#394856" stroke="#394856" x="1353.34796" y="605.35898" width="40" height="60" id="svg_29" rx="5" transform="rotate(-15 1373.35 635.358)"/>
        ...
        <g class="spot23">
          <rect @mouseover="showTooltip(23, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 23)" :class="{ occupied: guests[23] }" fill="#394856" stroke="#394856" x="1294.30034" y="621.35898" width="40" height="60" id="svg_30" rx="5" transform="rotate(-20 1314.3 651.358)"/>
        ...
        <g class="spot24">
          <rect @mouseover="showTooltip(24, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 24)" :class="{ occupied: guests[24] }" fill="#394856" stroke="#394856" x="1243.53844" y="643.73994" width="40" height="60" id="svg_31" rx="5" transform="rotate(-25 1263.54 673.739)"/>
        ...
        <g class="spot25">
          <rect @mouseover="showTooltip(25, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 25)" :class="{ occupied: guests[25] }" fill="#394856" stroke="#394856" x="1193.61002" y="664.94224" width="40" height="60" id="svg_32" rx="5" transform="rotate(-21 1213.61 694.942)"/>
        ...
        <g class="spot26">
          <rect @mouseover="showTooltip(26, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 26)" :class="{ occupied: guests[26] }" fill="#394856" stroke="#394856" x="1140.67541" y="678.03345" width="40" height="60" id="svg_33" rx="5" transform="rotate(-13 1160.67 708.033)"/>
        ...
        <g class="spot27">
          <rect @mouseover="showTooltip(27, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 27)" :class="{ occupied: guests[27] }" fill="#394856" stroke="#394856" x="1088.01462" y="682.78756" width="40" height="60" id="svg_34" rx="5" transform="rotate(-5 1108.01 712.787)"/>
        ...
        <g class="spot28">
          <rect @mouseover="showTooltip(28, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 28)" :class="{ occupied: guests[28] }" fill="#394856" stroke="#394856" x="1035.91939" y="682.40661" width="40" height="60" id="svg_35" rx="5"/>
        ...
        <g class="spot29">
          <rect @mouseover="showTooltip(29, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 29)" :class="{ occupied: guests[29] }" fill="#394856" stroke="#394856" x="983.25272" y="672.69231" width="40" height="60" id="svg_36" rx="5" transform="rotate(7 1003.25 702.692)"/>
        ...
        <g class="spot30">
          <rect @mouseover="showTooltip(30, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 30)" :class="{ occupied: guests[30] }" fill="#394856" stroke="#394856" x="931.15747" y="660.50185" width="40" height="60" id="svg_37" rx="5" transform="rotate(14 951.157 690.501)"/>
        ...
        <g class="spot31">
          <rect @mouseover="showTooltip(31, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 31)" :class="{ occupied: guests[31] }" fill="#394856" stroke="#394856" x="880.30033" y="643.16851" width="40" height="60" id="svg_38" rx="5" transform="rotate(20 900.3 673.168)"/>
        ...
        <g class="spot32">
          <rect @mouseover="showTooltip(32, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 32)" :class="{ occupied: guests[32] }" fill="#394856" stroke="#394856" x="1202.26455" y="560.57342" width="40" height="60" id="svg_39" rx="5" transform="rotate(-20 1222.26 590.573)"/>
        ...
        <g class="spot33">
          <rect @mouseover="showTooltip(33, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 33)" :class="{ occupied: guests[33] }" fill="#394856" stroke="#394856" x="1156.77653" y="576.21612" width="40" height="60" id="svg_40" rx="5" transform="rotate(-18 1176.78 606.215)"/>
        ...
        <g class="spot34">
          <rect @mouseover="showTooltip(34, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 34)" :class="{ occupied: guests[34] }" fill="#394856" stroke="#394856" x="1105.12776" y="587.83517" width="40" height="60" id="svg_41" rx="5" transform="rotate(-10 1125.13 617.835)"/>
        ...
        <g class="spot35">
          <rect @mouseover="showTooltip(35, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 35)" :class="{ occupied: guests[35] }" fill="#394856" stroke="#394856" x="1052.30033" y="592.78756" width="40" height="60" id="svg_42" rx="5" transform="rotate(-5 1072.3 622.787)"/>
        ...
        <g class="spot36">
          <rect @mouseover="showTooltip(36, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 36)" :class="{ occupied: guests[36] }" fill="#394856" stroke="#394856" x="994.68129" y="586.97802" width="40" height="60" id="svg_43" rx="5" transform="rotate(7 1014.68 616.977)"/>
        ...
        <g class="spot37">
          <rect @mouseover="showTooltip(37, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 37)" :class="{ occupied: guests[37] }" fill="#394856" stroke="#394856" x="938.97132" y="573.35899" width="40" height="60" id="svg_44" rx="5" transform="rotate(14 958.971 603.358)"/>
        ...
        <g class="spot38">
          <rect @mouseover="showTooltip(38, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 38)" :class="{ occupied: guests[38] }" fill="#394856" stroke="#394856" x="223.93837" y="346.13093" width="40" height="60" id="svg_17" rx="5" transform="rotate(40 243.938 376.131)"/>
        ...
        <g class="spot39">
          <rect @mouseover="showTooltip(39, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 39)" :class="{ occupied: guests[39] }" fill="#394856" stroke="#394856" x="187.76297" y="316.79759" width="40" height="60" id="svg_24" rx="5" transform="rotate(40 207.763 346.798)"/>
        ...
        <g class="spot40">
          <rect @mouseover="showTooltip(40, $event)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 40)" :class="{ occupied: guests[40] }" fill="#394856" stroke="#394856" x="91.62031" y="253.86191" width="35" height="60" id="svg_22" rx="5" transform="rotate(50 109.12 283.862)"/>
        ...
        <g class="spot41">
          <rect @mouseover="showTooltip(41)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 41)" :class="{ occupied: guests[41] }" fill="#394856" stroke="#394856" x="57.25771" y="222.49349" width="40" height="60" id="svg_26" rx="5" transform="rotate(55 77.2577 252.494)"/>
        ...
        <g class="spot42">
          <rect @mouseover="showTooltip(42)" @mouseleave="hideTooltip" @click="$emit('rectangleClicked', 42)" :class="{ occupied: guests[42] }" fill="#394856" stroke="#394856" x="38.1817" y="179.28881" width="40" height="60" id="svg_25" rx="5" transform="rotate(60 58.1817 209.289)"/>

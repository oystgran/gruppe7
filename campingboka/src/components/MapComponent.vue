...
<g>
 ...
 <rect @click="$emit('rectangleClicked', 2)" fill="#394856" stroke="#394856" x="1433.91939" y="670.59707" width="40" height="60" id="svg_3" rx="5" transform="rotate(-15 1453.92 700.596)"/>
 <rect @click="$emit('rectangleClicked', 3)" fill="#394856" stroke="#394856" x="1380.49082" y="682.50184" width="40" height="60" id="svg_4" rx="5" transform="rotate(-15 1400.49 712.501)"/>
 <rect @click="$emit('rectangleClicked', 1)" fill="#394856" stroke="#394856" x="1482.97202" y="654.50685" width="40" height="60" id="svg_5" rx="5" transform="rotate(-20 1502.97 684.506)"/>
 <rect @click="$emit('rectangleClicked', 9)" fill="#394856" stroke="#394856" x="1071.63368" y="779.54947" width="40" height="60" id="svg_6" rx="5" transform="rotate(-4 1091.63 809.549)"/>
 <rect @click="$emit('rectangleClicked', 7)" fill="#394856" stroke="#394856" x="1180.84205" y="767.68049" width="40" height="60" id="svg_7" rx="5" transform="rotate(-12 1200.84 797.68)"/>
 <rect @click="$emit('rectangleClicked', 14)" fill="#394856" stroke="#394856" x="812.30037" y="715.93041" width="40" height="60" id="svg_8" rx="5" transform="rotate(20 832.3 745.93)"/>
 <rect @click="$emit('rectangleClicked', 6)" fill="#394856" stroke="#394856" x="1233.12776" y="753.84124" width="40" height="60" id="svg_9" rx="5" transform="rotate(-20 1253.13 783.841)"/>
 <rect @click="$emit('rectangleClicked', 10)" fill="#394856" stroke="#394856" x="1014.01463" y="778.12089" width="40" height="60" id="svg_10" rx="5"/>
 <rect @click="$emit('rectangleClicked', 11)" fill="#394856" stroke="#394856" x="963.25272" y="768.4066" width="40" height="60" id="svg_11" rx="5" transform="rotate(7 983.253 798.406)"/>
 <rect @click="$emit('rectangleClicked', 4)" fill="#394856" stroke="#394856" x="1330.16931" y="703.75206" width="40" height="60" id="svg_12" rx="5" transform="rotate(-24 1350.17 733.751)"/>
 <rect @click="$emit('rectangleClicked', 5)" fill="#394856" stroke="#394856" x="1282.47853" y="729.96113" width="40" height="60" id="svg_13" rx="5" transform="rotate(-28 1302.48 759.961)"/>
 <rect @click="$emit('rectangleClicked', 8)" fill="#394856" stroke="#394856" x="1126.58604" y="775.49002" width="40" height="60" id="svg_14" rx="5" transform="rotate(-7 1146.59 805.489)"/>
 <rect @click="$emit('rectangleClicked', 16)" fill="#394856" stroke="#394856" x="709.06223" y="666.21612" width="40" height="60" id="svg_15" rx="5" transform="rotate(27 729.062 696.215)"/>
 <rect @click="$emit('rectangleClicked', 17)" fill="#394856" stroke="#394856" x="661.06222" y="639.35898" width="40" height="60" id="svg_16" rx="5" transform="rotate(28 681.062 669.358)"/>
 <rect @click="$emit('rectangleClicked', 38)" fill="#394856" stroke="#394856" x="223.93837" y="346.13093" width="40" height="60" id="svg_17" rx="5" transform="rotate(40 243.938 376.131)"/>
 <rect @click="$emit('rectangleClicked', 19)" fill="#394856" stroke="#394856" x="552.30034" y="595.54947" width="40" height="60" id="svg_18" rx="5" transform="rotate(15 572.3 625.549)"/>
 <rect @click="$emit('rectangleClicked', 12)" fill="#394856" stroke="#394856" x="912.58604" y="753.359" width="40" height="60" id="svg_19" rx="5" transform="rotate(14 932.586 783.358)"/>
 <rect @click="$emit('rectangleClicked', 18)" fill="#394856" stroke="#394856" x="607.34795" y="613.73993" width="40" height="60" id="svg_20" rx="5" transform="rotate(25 627.348 643.739)"/>
 <rect @click="$emit('rectangleClicked', 13)" fill="#394856" stroke="#394856" x="863.15747" y="736.02566" width="40" height="60" id="svg_21" rx="5" transform="rotate(20 883.157 766.025)"/>
 <rect @click="$emit('rectangleClicked', 40)" fill="#394856" stroke="#394856" x="91.62031" y="253.86191" width="35" height="60" id="svg_22" rx="5" transform="rotate(50 109.12 283.862)"/>
 <rect @click="$emit('rectangleClicked', 15)" fill="#394856" stroke="#394856" x="758.49084" y="691.54946" width="40" height="60" id="svg_23" rx="5" transform="rotate(24 778.491 721.549)"/>
 <rect @click="$emit('rectangleClicked', 39)" fill="#394856" stroke="#394856" x="187.76297" y="316.79759" width="40" height="60" id="svg_24" rx="5" transform="rotate(40 207.763 346.798)"/>
 <rect @click="$emit('rectangleClicked', 42)" fill="#394856" stroke="#394856" x="38.1817" y="179.28881" width="40" height="60" id="svg_25" rx="5" transform="rotate(60 58.1817 209.289)"/>
 <rect @click="$emit('rectangleClicked', 41)" fill="#394856" stroke="#394856" x="57.25771" y="222.49349" width="40" height="60" id="svg_26" rx="5" transform="rotate(55 77.2577 252.494)"/>
 <rect @click="$emit('rectangleClicked', 20)" fill="#394856" stroke="#394856" x="1455.82916" y="575.93542" width="40" height="60" id="svg_27" rx="5" transform="rotate(-20 1475.83 605.935)"/>
 <rect @click="$emit('rectangleClicked', 21)" fill="#394856" stroke="#394856" x="1406.77653" y="589.1685" width="40" height="60" id="svg_28" rx="5" transform="rotate(-15 1426.78 619.168)"/>
 <rect @click="$emit('rectangleClicked', 22)" fill="#394856" stroke="#394856" x="1353.34796" y="605.35898" width="40" height="60" id="svg_29" rx="5" transform="rotate(-15 1373.35 635.358)"/>
 <rect @click="$emit('rectangleClicked', 23)" fill="#394856" stroke="#394856" x="1294.30034" y="621.35898" width="40" height="60" id="svg_30" rx="5" transform="rotate(-20 1314.3 651.358)"/>
 <rect @click="$emit('rectangleClicked', 24)" fill="#394856" stroke="#394856" x="1243.53844" y="643.73994" width="40" height="60" id="svg_31" rx="5" transform="rotate(-25 1263.54 673.739)"/>
 <rect @click="$emit('rectangleClicked', 25)" fill="#394856" stroke="#394856" x="1193.61002" y="664.94224" width="40" height="60" id="svg_32" rx="5" transform="rotate(-21 1213.61 694.942)"/>
 <rect @click="$emit('rectangleClicked', 26)" fill="#394856" stroke="#394856" x="1140.67541" y="678.03345" width="40" height="60" id="svg_33" rx="5" transform="rotate(-13 1160.67 708.033)"/>
 <rect @click="$emit('rectangleClicked', 27)" fill="#394856" stroke="#394856" x="1088.01462" y="682.78756" width="40" height="60" id="svg_34" rx="5" transform="rotate(-5 1108.01 712.787)"/>
 <rect @click="$emit('rectangleClicked', 28)" fill="#394856" stroke="#394856" x="1035.91939" y="682.40661" width="40" height="60" id="svg_35" rx="5"/>
 <rect @click="$emit('rectangleClicked', 29)" fill="#394856" stroke="#394856" x="983.25272" y="672.69231" width="40" height="60" id="svg_36" rx="5" transform="rotate(7 1003.25 702.692)"/>
 <rect @click="$emit('rectangleClicked', 30)" fill="#394856" stroke="#394856" x="931.15747" y="660.50185" width="40" height="60" id="svg_37" rx="5" transform="rotate(14 951.157 690.501)"/>
 <rect @click="$emit('rectangleClicked', 31)" fill="#394856" stroke="#394856" x="880.30033" y="643.16851" width="40" height="60" id="svg_38" rx="5" transform="rotate(20 900.3 673.168)"/>
 <rect @click="$emit('rectangleClicked', 32)" fill="#394856" stroke="#394856" x="1202.26455" y="560.57342" width="40" height="60" id="svg_39" rx="5" transform="rotate(-20 1222.26 590.573)"/>
 <rect @click="$emit('rectangleClicked', 33)" fill="#394856" stroke="#394856" x="1156.77653" y="576.21612" width="40" height="60" id="svg_40" rx="5" transform="rotate(-18 1176.78 606.215)"/>
 <rect @click="$emit('rectangleClicked', 34)" fill="#394856" stroke="#394856" x="1105.12776" y="587.83517" width="40" height="60" id="svg_41" rx="5" transform="rotate(-10 1125.13 617.835)"/>
 <rect @click="$emit('rectangleClicked', 35)" fill="#394856" stroke="#394856" x="1052.30033" y="592.78756" width="40" height="60" id="svg_42" rx="5" transform="rotate(-5 1072.3 622.787)"/>
 <rect @click="$emit('rectangleClicked', 36)" fill="#394856" stroke="#394856" x="994.68129" y="586.97802" width="40" height="60" id="svg_43" rx="5" transform="rotate(7 1014.68 616.977)"/>
 <rect @click="$emit('rectangleClicked', 37)" fill="#394856" stroke="#394856" x="938.97132" y="573.35899" width="40" height="60" id="svg_44" rx="5" transform="rotate(14 958.971 603.358)"/>
 ...
 <text fill="#eeeeee" stroke="#eeeeee" x="764.18354" y="731.66415" id="svg_49" stroke-width="0" font-size="22" font-family="'Noto Sans Mono'" text-anchor="start" xml:space="preserve" font-weight="normal" style="cursor: move;" transform="rotate(24 777.385 723.108)">15</text>
